...
namespace Graball.General.Text.Formatter
{
    ...
    /// </summary>
    public class FormatExtractTextFromHtml : FormatNulled
    {
        /// <summary>
        /// <para>Construtor.</para>
        /// </summary>
        public FormatExtractTextFromHtml() : base() { }
        ...
        {
            string semHtmlTag = string.Format(new FormatRemoveTags(), "{0}", base.Format(format, arg, formatProvider));
