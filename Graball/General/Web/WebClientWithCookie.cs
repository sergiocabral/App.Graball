...
namespace Graball.General.Web
{
    ...
    public class WebClientWithCookie: WebClient
    {
        ...
        public WebClientWithCookieLoadResult Load(string url, string method = "GET", NameValueCollection fields = null, Encoding encoding = null)
        {
            if (encoding == null) encoding = Encoding.Default;
            var querystring = fields == null ? null : fields.GetQuerystring();
